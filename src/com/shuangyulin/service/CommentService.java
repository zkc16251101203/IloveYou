...
public class CommentService {
    ...
    /*按照查询条件分页查询评论记录*/
    public ArrayList<Comment> queryComment(Scenic scenicObj,String commentContent,UserInfo userObj,String commentTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != scenicObj && scenicObj.getScenicId()!= null && scenicObj.getScenicId()!= 0)  where += " and t_comment.scenicObj=" + scenicObj.getScenicId();
    	if(!commentContent.equals("")) where = where + " and t_comment.commentContent like '%" + commentContent + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Comment> queryComment(Scenic scenicObj,String commentContent,UserInfo userObj,String commentTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != scenicObj && scenicObj.getScenicId()!= null && scenicObj.getScenicId()!= 0)  where += " and t_comment.scenicObj=" + scenicObj.getScenicId();
    	if(!commentContent.equals("")) where = where + " and t_comment.commentContent like '%" + commentContent + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_comment.userObj='" + userObj.getUser_name() + "'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Scenic scenicObj,String commentContent,UserInfo userObj,String commentTime) throws Exception {
     	String where = "where 1=1";
    	if(null != scenicObj && scenicObj.getScenicId()!= null && scenicObj.getScenicId()!= 0)  where += " and t_comment.scenicObj=" + scenicObj.getScenicId();
    	if(!commentContent.equals("")) where = where + " and t_comment.commentContent like '%" + commentContent + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_comment.userObj='" + userObj.getUser_name() + "'";
