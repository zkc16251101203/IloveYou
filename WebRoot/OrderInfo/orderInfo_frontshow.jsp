...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">预定景点:</div>
		<div class="col-md-10 col-xs-6"><%=orderInfo.getScenicObj().getScenicName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">预定日期:</div>
		<div class="col-md-10 col-xs-6"><%=orderInfo.getOrderDate()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">预定价格:</div>
		<div class="col-md-10 col-xs-6"><%=orderInfo.getPrice()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">预定用户:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=orderInfo.getShState()%></div>
	</div>
	<div class="row bottom15">
