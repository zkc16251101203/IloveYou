...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#scenicTypeListPanel" aria-controls="scenicTypeListPanel" role="tab" data-toggle="tab">景点分类列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ScenicType/scenicType_frontAdd.jsp" style="display:none;">添加景点分类</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<scenicTypeList.size();i++) {
					    	            		...
					    	            		ScenicType scenicType = scenicTypeList.get(i); //获取到景点分类对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div style="display:none;">
		...
		<form name="scenicTypeQueryForm" id="scenicTypeQueryForm" action="<%=basePath %>ScenicType/frontlist" class="mar_t15" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;景点分类信息编辑</h4>
      </div>
...
function scenicTypeDelete(typeId) {
	if(confirm("确认删除这个记录")) {
		$.ajax({
			type : "POST",
			url : basePath + "ScenicType/deletes",
			data : {
				typeIds : typeId,
			},
