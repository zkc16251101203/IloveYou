				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>评论id</td><td>被评景点</td><td>评论内容</td><td>评论人</td><td>评论时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="commentQueryForm" id="commentQueryForm" action="<%=basePath %>Comment/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="scenicObj_scenicId">被评景点：</label>
			...
			<div class="form-group">
				...
				<input type="text" id="commentContent" name="commentContent" value="<%=commentContent %>" class="form-control" placeholder="请输入评论内容">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="comment_scenicObj_scenicId_edit" class="col-md-3 text-right">被评景点:</label>
		  	 <div class="col-md-9">
			    <select id="comment_scenicObj_scenicId_edit" name="comment.scenicObj.scenicId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="comment_commentContent_edit" class="col-md-3 text-right">评论内容:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="comment_commentContent_edit" name="comment.commentContent" class="form-control" placeholder="请输入评论内容">
			 </div>
		  </div>
		  <div class="form-group">
			...
			if (comment) {
				...
				$.ajax({
					...
					success: function(scenics,response,status) { 
						$("#comment_scenicObj_scenicId_edit").empty();
						var html="";
		        		$(scenics).each(function(i,scenic){
		        			html += "<option value='" + scenic.scenicId + "'>" + scenic.scenicName + "</option>";
		        		});
		        		$("#comment_scenicObj_scenicId_edit").html(html);
		        		$("#comment_scenicObj_scenicId_edit").val(comment.scenicObjPri);
					}
				});
				$("#comment_commentContent_edit").val(comment.commentContent);
				$.ajax({
