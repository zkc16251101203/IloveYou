...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">被评景点:</div>
		<div class="col-md-10 col-xs-6"><%=comment.getScenicObj().getScenicName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评论内容:</div>
		<div class="col-md-10 col-xs-6"><%=comment.getCommentContent()%></div>
	</div>
	<div class="row bottom15"> 
