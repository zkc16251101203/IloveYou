		       ...
		       text: "景点分类管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ScenicType/scenicType_add.jsp"
			    	   	},
			    		{
			    	   		text: "景点分类管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ScenicType/scenicType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "城市管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "City/city_add.jsp"
			    	   	},
			    		{
			    	   		text: "城市管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "City/city_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "景点管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Scenic/scenic_add.jsp"
			    	   	},
			    		{
			    	   		text: "景点管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Scenic/scenic_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "评论管理",
